...
public class HasPermissionInterceptorTest {
     ...
     */
    @InjectMocks
    private HasPermissionInterceptor interceptor;
     ...
     */
    @Test
    public void ifMethodHasPermissionThenProceed() throws Exception {
        // given
     ...
     */
    @Test
    public void ifClassHasPermissionThenProceed() throws Exception {
        // given
        when(this.mockIdentity.hasPermission(Permission.EDIT_SELF)).thenReturn(true);
     ...
     */
    @Test(expected = AuthorizationFailedException.class)
    public void ifPermissionMissingThenException() throws Exception {
        // given
